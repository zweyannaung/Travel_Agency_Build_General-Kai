...
const Subscribe = () => { 
  ...
  return (
    <div className='bg-green-50 w-screen px-5 md:px-10 DD:px-32 LL:px-0 LL:w-8/12 mx-auto py-12 LL:pt-32'>
      <div className={`relative overflow-hidden flex flex-col justify-between h-[370px] MIN:h-[320px] MIN1:h-[310px] MIN2:h-[290px] md:h-[370px] rounded-2xl  p-7 md:py-12 md:px-40 bg-gray-200 ${pageSub === "Myanmar" ? "font-MM MIN2:py-5 md:py-8 lg:py-12": "font-EN"}`} >
        ...
        <h1 className={`text-slate-800 text-[30px] md:text-[40px] xl:text-[50px] lg:w-[450px] xl:w-[680px] mx-auto font-bold  text-center leading-9 md:leading-[50px] xl:leading-[60px] ${pageSub === "Myanmar" && "font-black text-[27px] MIN2:text-[22px] md:text-[33px] xl:text-[36px] leading-relaxed MIN2:leading-[40px] md:leading-relaxed "}`}>{motherSub?.Subscribe_sub_1}</h1>
        <p className={` text-center text-sm lg:w-[500px] xl:w-[650px] mx-auto leading-6 MIN2:text-base text-slate-600 ${pageSub === "Myanmar" && "leading-loose MIN2:leading-[30px] md:w-full "}`}>{motherSub?.Subscribe_sub_2} </p>
        <div className=' relative lg:w-[500px] xl:w-[650px] mx-auto '>
            ...
            <div className="relative ">
              ...
              <input type="text" id="input-group-1" className="bg-green-50 border-none text-slate-700 focus:ring-0 focus:border-none block w-full px-10 xl:px-10 py-4 xl:py-5 rounded-xl text-sm xl:text-base shadow-lg  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-0 dark:focus:border-blue-500" placeholder="Enter your email"/>
            </div>
            <a href='#' className='absolute top-[12%] xl:top-[18%] right-[2%] w-10 h-10 flex items-center justify-center rounded-full bg-slate-800 '><ArrowRight className='text-base md:text-lg text-white'/></a>
        </div>
      </div>
    </div>
  )
