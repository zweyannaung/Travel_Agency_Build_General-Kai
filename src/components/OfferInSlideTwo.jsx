...
const OfferInSlideTwo = () => {
  ...
  return (
    <div className=' space-y-7 MIN1:space-y-10 '>
      <h1 className='text-3xl font-black text-center MIN1:text-4xl md:text-4xl'>{motherSub?.Offer_Title_sub}</h1>
      <div className='grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-8 xl:gap-6'>
        <div className='w-full h-auto space-y-2 group  cursor-pointer'>
            ...
            <h3 className='text-center font-black text-base MIN2:text-lg transition-all duration-500 group-hover:text-blue-700'>{motherSub?.Offer_sub_1}</h3>
        </div>
        <div className='w-full h-auto space-y-2 group cursor-pointer'>
            ...
            <h3 className='text-center font-black text-base MIN2:text-lg transition-all duration-500 group-hover:text-blue-700'>{motherSub?.Offer_sub_2}</h3>
        </div>
        <div className='w-full h-auto space-y-2 group cursor-pointer'>
            ...
            <h3 className='text-center font-black text-base MIN2:text-lg transition-all duration-500 group-hover:text-blue-700'>{motherSub?.Offer_sub_3}</h3>
        </div>
        <div className='w-full h-auto space-y-2 group cursor-pointer'>
            ...
            <h3 className='text-center font-black text-base MIN2:text-lg transition-all duration-500 group-hover:text-blue-700'>{motherSub?.Offer_sub_4}</h3>
        </div>
        <div className='w-full h-auto space-y-2 group cursor-pointer'>
            ...
            <h3 className='text-center font-black text-base MIN2:text-lg transition-all duration-500 group-hover:text-blue-700'>{motherSub?.Offer_sub_5}</h3>
        </div>
        <div className='w-full h-auto space-y-2 group cursor-pointer'>
            <div className='h-28 MIN1:h-32 MIN2:h-52 md:h-44 lg:h-48 xl:h-36 2xl:h-40 LL:h-52 w-full bg-gray-300 rounded-2xl flex items-center justify-center'><div className='h-12 w-12 rounded-full bg-blue-700 flex items-center justify-center'><ArrowRight className='text-lg text-white'/></div></div>
            <h3 className='text-center font-black text-base MIN2:text-lg transition-all duration-500 group-hover:text-blue-700'>{motherSub?.Offer_sub_6}</h3>
        </div>
      </div>
    </div>
  )
