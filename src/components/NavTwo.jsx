            ...
            <div className='col-span-2'>
                ...
                <div className='grid grid-cols-2 gap-5'>
                    <ul className=' bg-transparent text-base lg:text-sm LL:text-base font-semibold text-slate-500'>
                        <li onClick={modalAlert} className='cursor-pointer flex items-center space-x-1 ps-5 py-2 duration-700 border border-transparent rounded-lg hover:bg-slate-200 hover:text-blue-500'>
